...
site_data = [
{name: "Star Lounge", lat: 41.924145, lon: -87.689843, contents: "It's high time we lit the <em>star</em>s again"},
{name: "Archie's", lat: 41.897875, lon: -87.692008, contents: "<img src='images/archies.jpg' width='50%' height='50%' />"}
];
...
have_coordinates = function(position) {
		...
		if(distance.ft < threshold_ft) {
			...
			document.getElementById("gps_content").innerHTML = site_data[i].contents;
		} else {
